...
fisher.pl --except -fc 2 $1.chr_rRNA_reads.txt $1.polyA_note.txt | fisher.pl -fc 3 ./annotations/mouse/chr_pc.txt - >$1.chr_pc.polyA_note.pass1.txt
fisher.pl --except -fc 2 $1.chr_rRNA_reads.txt $1.polyA_note.txt | fisher.pl -fc 3 ./annotations/mouse/chr_lnc.txt - >$1.chr_lnc.polyA_note.pass1.txt
fisher.pl --except -fc 2 $1.chr_rRNA_reads.txt $1.polyA_note.txt | fisher.pl -fc 3 ./annotations/mouse/mt_pc.txt - >$1.mt_pc.polyA_note.pass1.txt
fisher.pl --except -fc 2 $1.chr_rRNA_reads.txt $1.polyA_note.txt | fisher.pl -fc 3 ./annotations/mouse/mt_rRNA.txt - >$1.mt_rRNA.polyA_note.pass1.txt
fisher.pl --except -fc 2 $1.chr_rRNA_reads.txt $1.polyA_note.txt | fisher.pl -fc 3 ./annotations/mouse/hist.txt - >$1.hist.polyA_note.pass1.txt
fisher.pl --except -fc 2 $1.chr_rRNA_reads.txt $1.polyA_note.txt | fisher.pl -fc 3 ./annotations/mouse/hist_var.txt - >$1.hist_var.polyA_note.pass1.txt
