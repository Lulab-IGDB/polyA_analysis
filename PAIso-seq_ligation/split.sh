...
for i in {001..100}; do echo "python ./PAIso-seq_ligation/CCS_split_clean_UMI_1stLigation_v3.1.py  $1.ccs.part-${i}.fastq $1.ccs.pass.txt 1>$1.${i}.out.txt 2>$1.${i}.err.txt"; done >demultiplex_run.sh

ParaFly -c demultiplex_run.sh -CPU 5 
