...
fisher.pl --except -fc 2 $1.chr_rRNA_reads.txt $1.polyA_note.UMI_uniq.txt | fisher.pl -fc 3 ./annotations/human/chr_pc.txt - >$1.chr_pc.polyA_note.UMI_uniq.pass1.txt
fisher.pl --except -fc 2 $1.chr_rRNA_reads.txt $1.polyA_note.UMI_uniq.txt | fisher.pl -fc 3 ./annotations/human/chr_lnc.txt - >$1.chr_lnc.polyA_note.UMI_uniq.pass1.txt
fisher.pl --except -fc 2 $1.chr_rRNA_reads.txt $1.polyA_note.UMI_uniq.txt | fisher.pl -fc 3 ./annotations/human/mt_pc.txt - >$1.mt_pc.polyA_note.UMI_uniq.pass1.txt
fisher.pl --except -fc 2 $1.chr_rRNA_reads.txt $1.polyA_note.UMI_uniq.txt | fisher.pl -fc 3 ./annotations/human/mt_rRNA.txt - >$1.mt_rRNA.polyA_note.UMI_uniq.pass1.txt
fisher.pl --except -fc 2 $1.chr_rRNA_reads.txt $1.polyA_note.UMI_uniq.txt | fisher.pl -fc 3 ./annotations/human/hist.txt - >$1.hist.polyA_note.UMI_uniq.pass1.txt
fisher.pl --except -fc 2 $1.chr_rRNA_reads.txt $1.polyA_note.UMI_uniq.txt | fisher.pl -fc 3 ./annotations/human/hist_var.txt - >$1.hist_var.polyA_note.UMI_uniq.pass1.txt
