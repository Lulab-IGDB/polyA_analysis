...
minimap2 -ax splice -uf --secondary=no -t 40 -L --MD --cs --junc-bed ./mouse/gencode.vM25.primary_assembly.annotation.bed ./annotations/mouse/mouse.mmi $1.clean.fastq.gz 2>align.log | samtools view -bS >$1.clean.aligned.bam
...
featureCounts -L -g gene_id -t exon -s 1 -R CORE -a ./annotations/mouse/gencode.vM25.primary_assembly.annotation.gtf -o $1.featureCounts $1.clean.filter.bam &>featureCounts.log
